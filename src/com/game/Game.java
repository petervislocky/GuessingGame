...
public class Game {
	...
	public int selectDifficulty() {
		...
		//this resource leak is unfixable due to the creation of multiple scanner objects. I should fix that but I am not going to because it involves redoing all my exception handling.
